<section class="contain-profil mg-t">
    ...
    <div class="box-title">
        <h2>
            ...
            <?php if($data_projet['github'] != ""): ?><a href="<?= $data_projet['github'] ?>" title="voir projet sur github" target="_blank"><i style="color: white;font-size:20px;" class="fa-brands fa-github"></i></a> <?php endif ?>
